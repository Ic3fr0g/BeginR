---
title: "2. Vectors, Matrices and Dataframes"
author: "Ic3fr0g"
output:
...
a == c(12,18,30,48)
```
Vectors can also be passed to various functions:
```{r}
# What is sine of "a" ?
sqrt(a)
```

#### 2.1.5 Plotting Vectors
...
```{r}
cbind(star_wars, total_sales)
```

#### 2.2.4 Plotting for matrices
